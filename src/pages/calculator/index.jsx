  ...
  return (
    <div className="mx-auto max-w-screen-xl px-5 py-10 flex flex-col items-center">
      ...
      <div className="bg-gray-200 w-full px-5 py-10 grid grid-cols-3 gap-5">
        ...
        <button className="col-span-3 py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
          Add row
        </button>
